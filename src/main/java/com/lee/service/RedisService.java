...
public interface RedisService {
    ...
    long lpush(String key, String value) throws RedisConnectException;

    List<String> brpop(int timeout, String key) throws RedisConnectException;

    Long incrby(String key,Integer integer) throws RedisConnectException ;

    Long incr(String key) throws RedisConnectException;

    Long decr(String key)throws RedisConnectException;

    Boolean sismember(String key,String value) throws RedisConnectException;

    Long sadd(String key,String value) throws RedisConnectException;

    Long sadd(String key,String... values) throws RedisConnectException;

    Long scard(String key) throws RedisConnectException;

    Long srem(String key,String value) throws RedisConnectException;
