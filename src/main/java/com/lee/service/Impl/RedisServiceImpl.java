...
/**
 * @author libin
 * @date 2020-10-23 12:54
 */
import com.lee.domain.RedisInfo;
import com.lee.exception.RedisConnectException;
import com.lee.function.JedisExecutor;
...
public class RedisServiceImpl implements RedisService {
    ...
    @Override
    public List<String> brpop(int timeout, String key) throws RedisConnectException{
        return this.excuteByJedis(j->j.blpop(timeout,key));
    }

    @Override
    public Long incrby(String key,Integer integer) throws RedisConnectException {
        return this.excuteByJedis(j->j.incrBy(key,integer));
    }
    ...
    @Override
    public Long sadd(String key, String... values) throws RedisConnectException {
        return this.excuteByJedis(j->j.sadd(key,values));
    }

    @Override
    public Long scard(String key) throws RedisConnectException {
        return this.excuteByJedis(j->j.scard(key));
    }

    @Override
    public Long srem(String key,String value) throws RedisConnectException {
        return this.excuteByJedis(j->j.srem(key,value));
    }
    ...
    @Override
    public Boolean sismember(String key,String value) throws RedisConnectException {
        return this.excuteByJedis(j->j.sismember(key,value));
    }
